...
权威源码：[`Common/ClientTypes.h`](../Common/ClientTypes.h) 与各域 `*.proto`、[`protocal/InternalMsg.h`](../protocal/InternalMsg.h)。共享层维护见 [COMMON.md](COMMON.md)。
...
**Protobuf body**：`body` 为 proto3 二进制，不含 module/sub 前缀。6 字节 `MsgHeader` 路由不变。
...
路由枚举定义于 [`Common/ClientTypes.h`](../Common/ClientTypes.h)；Protobuf message 见 [`Common/Common.txt`](../Common/Common.txt)。
...
4. [`Common/ClientTypes.h`](../Common/ClientTypes.h) — 仅当新增 `ClientModule` 时修改
5. [`GatewayServer/ClientMsgValidator.h`](../GatewayServer/ClientMsgValidator.h) — 白名单、长度、Protobuf payload 校验
6. [`GatewayServer/ClientMsgRouter.h`](../GatewayServer/ClientMsgRouter.h) — LOCAL / SCENE / DROP
